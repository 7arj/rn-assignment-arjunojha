...
```bash
git clone https://github.com/your-username/rn-assignment-your-name.git
...
This project uses Expo Router with the file-based routing system. The counter app is located in the home tab at `app/(tabs)/index.tsx`.
-  Increment and decrement counter
-  Reset button to set counter to 0
-  Smooth scale and fade animations on count change
-  Clean and responsive UI
